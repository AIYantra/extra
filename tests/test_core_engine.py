...
4. UI Automation Semantic Plane & Set-of-Mark
5. Input Engine Mechanics
6. Stall Breaker & 2-Strike Protection
...
def run_tests() -> None:
    ...
    # 1. Geometry & DPI
    print("\n[1/7] Testing Geometry & DPI Awareness...")
    ...
    # 2. Capture Engine
    print("\n[2/7] Testing High-Speed Screen Capture...")
    ...
    # 3. Focus & Window Management
    print("\n[3/7] Testing Window Focus & Enumeration...")
    ...
    print("\n[4/7] Testing UI Automation Semantic Plane & Set-of-Mark...")
    ...
    # 5. Input Engine Mechanics
    print("\n[5/7] Testing Input Engine Mechanics...")
    ...
    print("\n[6/7] Testing Stall Breaker & 2-Strike Protection...")
    ...
    # Visual recovery check (with fallback when 0 UI elements annotated, e.g. pending macOS Accessibility permissions)
    recovery_img = ann_img
    if len(elements) == 0:
        from PIL import ImageOps
        recovery_img = ImageOps.invert(cap.image.convert("RGB"))

    out3 = breaker.evaluate_action(cap.image, recovery_img, before_hwnd=1, after_hwnd=1, action_name="test_recovery")
