"""
Project Extra — Win32 Geometry & Multi-Monitor DPI Normalization Engine
...
class WindowsGeometry(AbstractGeometry):
    """Windows implementation of the AbstractGeometry interface."""
